...
def draw_progression(
    ...
    temp_path = Path(f"generated_paper_components/figure_teaser_images/{tag}")
...
if __name__ == "__main__":
    ...
    top = Path("generated_paper_components/figure_teaser_images/top_thing.png")
    image.save(top)
    ...
    bottom = Path("generated_paper_components/figure_teaser_images/bottom_thing.png")
    image.save(bottom)
    ...
    base = Path("generated_paper_components/figure_teaser")
